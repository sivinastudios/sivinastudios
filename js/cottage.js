...
function updatePageUI() {
    ...
    const isPageSeven = currentPage === 7;
    const isPageEight = currentPage === 8;
    const isPageNine = currentPage === 9;
    const isLatePage = currentPage >= 6;
    ...
    pageFrame.classList.toggle("page-seven-living", isPageSeven);
    pageFrame.classList.toggle("page-eight-living", isPageEight);
    pageFrame.classList.toggle("page-nine-living", isPageNine);
    pageFrame.classList.toggle("page-late", isLatePage);
